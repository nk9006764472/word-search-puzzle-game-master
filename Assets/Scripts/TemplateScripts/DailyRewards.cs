...
//			Collect();
	...
	{
//		GameObject.Find("SpotLight").GetComponent<Animation>().Play("DailyReward"+TrenutniDan); // ova linija originalno treba da bude zakomentarisana
...
//		}
	...
	public IEnumerator moneyCounter(int kolicina)
	{
		...
		// Podesavamo text komponente za coine
